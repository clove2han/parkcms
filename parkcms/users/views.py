...
def memberlist(request):
    ...
    return render(request, 'html/member-list.html', {"user_list":user_list})

def memberdel(request):

    return render(request, 'html/member-del.html')

def memberadd(request):
    return render(request, 'html/member-add.html')

def welcome(request):
    return render(request, 'html/welcome.html')

def orderlist(request):
    return render(request, 'html/order-list.html')

def orderadd(request):
    return render(request, 'html/order-add.html')
...
def adminlist(request):
    user_list = models.UserInfo.objects.filter()
    return render(request, 'html/admin-list.html', {"user_list":user_list})

def adminedit(request):
    return render(request, 'html/admin-edit.html')

def adminadd(request):
    return render(request, 'html/admin-add.html')
